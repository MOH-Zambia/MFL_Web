...
/* @var $searchModel backend\models\FacilityOwnershipSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Facility ownerships';
        ...
        <p>
            ...
            if (User::userIsAllowedTo('Manage facility ownerships')) {
                echo '<button class="btn btn-primary btn-sm" href="#" onclick="$(\'#addNewModal\').modal(); 
                    return false;"><i class="fa fa-plus"></i> Add Facility ownership</button>';
        ...
        GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'filter' => \backend\models\FacilityOwnership::getNames(),
                        ...
                        'delete' => function ($url, $model) {
                            if (User::userIsAllowedTo('Manage facility ownerships')) {
                                return Html::a(
                                            ...
                                            'title' => 'Remove facility ownership',
                                            'data-toggle' => 'tooltip',
                                            'data-placement' => 'top',
                                            'data' => [
                                                'confirm' => 'Are you sure you want to remove ' . $model->name . ' facility ownership?<br>'
                                                . 'Facility ownership will only be removed if its not being used by the system!',
                                                'method' => 'post',
                                            ],
                                            'style' => "padding:5px;",
                                            'class' => 'bt btn-lg'
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add Facility ownership</h5>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        $form->field($model, 'name', ['enableAjaxValidation' => true])->textInput(['maxlength' => true, 'placeholder' =>
                            'Name of facility ownership', 'id' => "province", 'required' => true,])
                        ?>
                    </div>
                    <div class="col-lg-4">
                        <h4>Instructions</h4>
