...
/* @var $searchModel backend\models\MFLInfrastructureSearch */
        ...
        GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'filter' => \backend\models\MFLInfrastructure::getNames(),
                        ...
                        'delete' => function ($url, $model) {
                            if (User::userIsAllowedTo('Manage MFL infrastructure')) {
                                return Html::a(
                                            ...
                                            'data-placement' => 'top',
                                            'data' => [
                                                'confirm' => 'Are you sure you want to remove ' . $model->name . ' MFL infrastructure?<br>'
                                                . 'Infrastructure will only be removed if its not being used by the system!',
                                                'method' => 'post',
                                            ],
                                            'style' => "padding:5px;",
                                            'class' => 'bt btn-lg'
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add MFL infrastructure</h5>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        $form->field($model, 'name', ['enableAjaxValidation' => true])->textInput(['maxlength' => true, 'placeholder' =>
                            'Name of infrastructure', 'id' => "province", 'required' => true,])
                        ?>
                    </div>
                    <div class="col-lg-4">
                        <h4>Instructions</h4>
