...
/* @var $searchModel backend\models\OperatinghoursSearch */
        ...
        <p>
            ...
            if (User::userIsAllowedTo('Manage MFL operating hours')) {
                echo '<button class="btn btn-primary btn-sm" href="#" onclick="$(\'#addNewModal\').modal(); 
                    return false;"><i class="fa fa-plus"></i> Add operation hour</button>';
        ...
        GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'filter' => \backend\models\Operatinghours::getNames(),
                        ...
                        'delete' => function ($url, $model) {
                            if (User::userIsAllowedTo('Manage MFL operating hours')) {
                                return Html::a(
                                            ...
                                            'title' => 'Remove operation hour',
                                            'data-toggle' => 'tooltip',
                                            'data-placement' => 'top',
                                            'data' => [
                                                'confirm' => 'Are you sure you want to remove ' . $model->name . ' MFL operating hour?<br>'
                                                . 'Operating hour will only be removed if its not being used by the system!',
                                                'method' => 'post',
                                            ],
                                            'style' => "padding:5px;",
                                            'class' => 'bt btn-lg'
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add MFL Operating hour</h5>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        $form->field($model, 'name', ['enableAjaxValidation' => true])->textInput(['maxlength' => true, 'placeholder' =>
                            'Name of operation hour', 'id' => "province", 'required' => true,])
                        ?>
                    </div>
                    <div class="col-lg-4">
                        <h4>Instructions</h4>
