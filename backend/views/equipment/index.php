        ...
        GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'filter' => \backend\models\Equipment::getNames(),
                        ...
                        'delete' => function ($url, $model) {
                            if (User::userIsAllowedTo('Manage MFL equipments')) {
                                return Html::a(
                                            ...
                                            'data-placement' => 'top',
                                            'data' => [
                                                'confirm' => 'Are you sure you want to remove ' . $model->name . ' MFL equipment?<br>'
                                                . 'Equipment will only be removed if its not being used by the system!',
                                                'method' => 'post',
                                            ],
                                            'style' => "padding:5px;",
                                            'class' => 'bt btn-lg'
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add MFL Equipment</h5>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        $form->field($model, 'name', ['enableAjaxValidation' => true])->textInput(['maxlength' => true, 'placeholder' =>
                            'Name of equipment', 'id' => "province", 'required' => true,])
                        ?>
                    </div>
                    <div class="col-lg-4">
                        <h4>Instructions</h4>
