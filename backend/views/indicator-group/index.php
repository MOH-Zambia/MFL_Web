...
/* @var $searchModel backend\models\IndicatorGroupSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Indicator groups';
        ...
        <p>
            ...
            if (User::userIsAllowedTo('Manage indicator groups')) {
                ...
                echo '<button class="btn btn-primary btn-xs" href="#" onclick="$(\'#addNewModal\').modal(); 
                   return false;"><i class="fa fa-plus"></i> Add indicator group</button>';
            }
            ?>
        </p>
        <?=
                ...
                ['class' => ActionColumn::className(),
                    ...
                    'buttons' => [
                        'delete' => function ($url, $model) {
                            if (User::userIsAllowedTo('Remove indicator groups')) {
                                return Html::a(
                                            ...
                                            'data-placement' => 'top',
                                            'data' => [
                                                'confirm' => 'Are you sure you want to remove indicator group:' . $model->name . '?<br>'
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add new indicator group</h5>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        $form->field($model, 'name', ['enableAjaxValidation' => true])->textInput(['maxlength' => true, 'placeholder' =>
                            'Name of indicator group', 'required' => true,])
                        ?>
                        <?=
                        $form->field($model, 'description')->textarea(['rows' => 4, 'placeholder' =>
                            'Indicator group description'])->label("Description ");
                        ?>
                    </div>
                    <div class="col-lg-4">
                        <h4>Instructions</h4>
