...
/* @var $searchModel backend\models\MFLLablevelSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Lab levels';
        ...
        <p>
            ...
            if (User::userIsAllowedTo('Manage MFL lab levels')) {
                echo '<button class="btn btn-primary btn-sm" href="#" onclick="$(\'#addNewModal\').modal(); 
                    return false;"><i class="fa fa-plus"></i> Add lab level</button>';
        ...
        GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'filter' => \backend\models\MFLLablevel::getNames(),
                        ...
                        'delete' => function ($url, $model) {
                            if (User::userIsAllowedTo('Manage MFL lab levels')) {
                                return Html::a(
                                            ...
                                            'data-placement' => 'top',
                                            'data' => [
                                                'confirm' => 'Are you sure you want to remove ' . $model->name . ' MFL lab level?<br>'
                                                . 'Lab level will only be removed if its not being used by the system!',
                                                'method' => 'post',
                                            ],
                                            'style' => "padding:5px;",
                                            'class' => 'bt btn-lg'
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add MFL Lab level</h5>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        $form->field($model, 'name', ['enableAjaxValidation' => true])->textInput(['maxlength' => true, 'placeholder' =>
                            'Name of lab level', 'id' => "province", 'required' => true,])
                        ?>
                    </div>
                    <div class="col-lg-4">
                        <h4>Instructions</h4>
